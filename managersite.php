        ...
        <div class="wrapper">
            ...
            if (isset($_POST['Submit'])){
                    if (!empty($_POST['username'])&&
                        ...
                        if (!$result || !$result1) echo "INSERT failed: $query<br>" .
                        $conn->error . "<br><br>";
                        else echo"Inserted successfully";
                        //refresh page
                        header( "Refresh:2; url='managersite.php'");
                    }else{
...
if (!empty($_POST['delete'])):
    ...
    //refresh page
    header( "Refresh:1; url='managersite.php'");
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
    <div class="block">
                ...
                <input type="Submit" name="Submit" value="Insert a Post">
  ...
  <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <td>" . $row["roomtype"]. "</td>
                    <td>" . $row["info"]. "</td>";
                    echo "<td><input type='checkbox' name='posts[]' id='posts' value='$id' </td> </tr>";
                }
                echo "</table>";
            } else {
                echo "0 results";
